...
<body>
  ...
  $SqlEventos   = ("SELECT * FROM lugar");
  $resulEventos = mysqli_query($conn, $SqlEventos);

  $SqlEvento   = ("SELECT * FROM lugar WHERE id = 1");
  $resulEvento = mysqli_query($conn, $SqlEvento);
  $dataFecha = mysqli_fetch_array($resulEvento)
  ...
  <h1> <?php
        ...
        $fecha = $dataFecha['fecha_inicio'];
        $fechaEntera = strtotime($fecha);
        $anoForm = date('m', $fechaEntera);
