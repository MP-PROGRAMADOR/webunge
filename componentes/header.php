...
<section class="w3l-top-menu-1">
	...
	<header class="row top-menu-top">
		<div class="accounts col-md-9 col-6">
				<li class="top_li"><span class="fa fa-phone"></span><a href="tel:+142 5897555">+240 333 091 644</a> </li>
				<li class="top_li1"><span class="fa fa-envelope-o"></span> <a href="mailto:internacional@unge-edu.gq" class="mail"> internacional@unge-edu.gq</a>	</li>
		</div>
		<div class="social-top col-md-3 col-6">
			<a href="https://campusvirtualunge.com/login/index.php" target="_blank" class="btn btn-secondary btn-theme4">Campus Virtual</a>
		</div>
	</header>
</div>
</div>
...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
    ...
    <a class="navbar-brand" href="index.php">
        <img src="./assets//images/logo.jpeg" alt="Logotipo" title="Your logo" style="height:35px;" />
       <!-- <h1>UNGE</h1>-->
    </a> 
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="about.php">Acerca de la UNGE</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="./facmalabo.php">
                Facultades de Malabo
              </a>
              <a class="dropdown-item" href="./facbata.php">Facultades de Bata</a>
              <a class="dropdown-item" href="./facmongomo.php">Facultad de Mongomo</a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://www.ucm.es/eca/" target="_blank">UCM</a>
          </li>
