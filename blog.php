		  ...
		  <div class="right-side-bar">
			<aside>
			  ...
			  <form class="form-inline search-form" action="#" method="post">
				<input class="form-control" type="search" placeholder="Buscar..." aria-label="email" required="">
			...
			<aside class="posts p-4 border">
			  ...
			  <ul class="category">
				<li><a href="#link"><span class="fa fa-angle-right"></span>Todas <label> (11)</label></a></li>
				<li><a href="#link"><span class="fa fa-angle-right"></span>Tecnologia <label>(24)</label></a></li>
				<li><a href="#link"><span class="fa fa-angle-right"></span>Ciencias <label>(18)</label></a></li>
				<li><a href="#link"><span class="fa fa-angle-right"></span>Cultura <label>(08)</label></a></li>
				<li><a href="#link"><span class="fa fa-angle-right"></span>Economia <label>(38)</label></a></li>
				<li><a href="#link"><span class="fa fa-angle-right"></span>Deporte <label>(26)</label></a></li>
				<li><a href="#link"><span class="fa fa-angle-right"></span>Sociedad <label>(26)</label></a></li>
			  </ul>
			</aside>
			<aside class="posts p-4 border">
