              ...
              <div class="pricing-chart col-lg-6">
                ...
                <div class="tatest-top mt-md-5 mt-4">
                        ...
                        <div class="price-box btn-layout bt6 top-middle-1">
                            <div class="grid grid-column-2">
                                    <div class="column-6">
                                            <img src="assets/images/unge/9.jpg" alt="" class="img-fluid">
                                        </div>
                                <div class="column1">
                                   <div class="job-info">
                                        <h6 class="pricehead"><a href="blog.php">	
                                        La UNGE recibe una formacion sobre planificacion familiar</a></h6>
                                       <h5>Abr 2, 2023</h5>
                        ...
                        <div class="price-box btn-layout bt6">
                            <div class="grid grid-column-2">
                                    <div class="column-6">
                                            <img src="assets/images/unge/6.jpg" alt="" class="img-fluid">
                                        </div>
                                <div class="column1">                                  
                                    <div class="job-info">
                                        <h6 class="pricehead"><a href="blog.php">	
                                          La UNGE publica una oferta de 31 becas de formacion para sus profesores
                                           </a></h6>
                                        <h5>May 25, 2023</h5>                                        
                                    </div>
                                </div>                              
                    ...
                    <div class="w3l-faq-page col-lg-6 pl-3 pl-lg-5 mt-lg-0 mt-5">
                        ...
                        <div class="events-top mt-4">
                            ...
                            <div class="events-top-right">
                                <h6 class="pricehead">
                                  <a href="blog.php">	                                    
                                    Día Mundial de la Libertad de Prensa en la UNGE
                                  </a>
                                </h6>
                                    <p class="mb-2 mt-3">
                                      Esta fecha tan señalada, el 3 de mayo de cada año, ha  sido declarada por la ONU, como Día Mundial de Libertad de Prensa
                                    </p>
                                    <li>07:00 - 10:00 </li>
                                    <li class="melb">Campus I</li>
                            </div>
